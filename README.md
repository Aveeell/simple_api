...
{
    "id"        //id пользователя
    "offset"    //пропуск первых N записей                   [аналогичен OFFSET в sql]
    "limit"     //максимальное количество записей            [аналогичен LIMIT в sql]
    "sort"      //тип сортировки <DESC | ASC>                [аналогичен DESC | ASC  в sql]
    "sort_col"  //по какому столбцу производить сортировку   [аналогичен ORDER BY в sql]
}
```
